<?php
    /**
     * Скрипт для переноса слов из файлов в БД.
     * Перед использованием - в скрипте поменять индекс изучаемого языка на актуальный
     * Сохранные данные будут в последнем созданном списке
     */
